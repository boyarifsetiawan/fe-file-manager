...
<script setup>
	...
	import { fileDeleteUrl } from "../../Helper/routes-api";
	import { useAuthStore } from "../../store/useAuthStore";

	// Uses
	const fileStore = useFilesStore();
	const deleteFilesForm = new Form({
		all: null,
		ids: [],
		parent_id: null,
	});
	...
	function onDeleteConfirm() {
		deleteFilesForm.parent_id = fileStore.folder.id;
		if (props.deleteAll) {
			deleteFilesForm.all = true;
		} else {
			deleteFilesForm.ids = props.deleteIds;
		}
		deleteFilesForm.delete(fileDeleteUrl,{
			headers : {
