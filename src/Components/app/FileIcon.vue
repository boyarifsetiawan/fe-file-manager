	...
	<span class="w-6 h-6 inline-flex items-center justify-center mr-2">
		...
		<template v-else>
			...
			<img
				...
				:src="`/src/assets/images/icon/pdf.png`"
			/>
			<img
				class="max-w-full"
				v-else-if="isAudio(file)"
				:src="`/src/assets/images/icon/audio.png`"
			/>
			<img
				class="max-w-full"
			...
			<img
				...
				:src="`/src/assets/images/icon/word.png`"
			/>
			<img
				class="max-w-full"
			...
			<img
				class="max-w-full"
				v-else-if="isZip(file)"
				:src="`/src/assets/images/icon/zip.png`"
			/>
			<img
				class="max-w-full"
				v-else-if="isText(file)"
				:src="`/src/assets/images/icon/txt-file.png`"
			/>
			<img
				class="max-w-full"
				v-else
				:src="`/src/assets/images/icon/attach-file.png`"
			/>
		</template>
	</span>
</template>
